...
//-----------------------------------------------------------------------------
   always @ (posedge i_clk or negedge i_arst_n) begin
      if (~i_arst_n) begin
         pifo_data0  <= {{CTW{-'b1}},{MTW{1'b0}},{PTW{1'b1}}};
         pifo_data1  <= {{CTW{-'b1}},{MTW{1'b0}},{PTW{1'b1}}};
         pifo_data2  <= {{CTW{-'b1}},{MTW{1'b0}},{PTW{1'b1}}};
         pifo_data3  <= {{CTW{-'b1}},{MTW{1'b0}},{PTW{1'b1}}};		 
         latch_data  <= 'b1;
      end else begin
         case ({i_push,i_pop})
         2'b00: begin
...
//-----------------------------------------------------------------------------
   always @ * begin
      ...
      if (pifo_data0[(CTW+MTW+PTW)-1:(MTW+PTW)] != 0) begin
         min_sub_tree[1:0] = 2'b00;	  
      end else if (pifo_data1[(CTW+MTW+PTW)-1:(MTW+PTW)] != 0) begin
         min_sub_tree[1:0] = 2'b01;	  
      end else if (pifo_data2[(CTW+MTW+PTW)-1:(MTW+PTW)] != 0) begin
